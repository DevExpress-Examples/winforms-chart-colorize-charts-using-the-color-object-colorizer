...
'#Region "#BarSeries"
            ...
            Dim barSeries As Series = New Series() With {.DataSource = LoadData(filepath), .Colorizer = New ColorObjectColorizer(), .ArgumentDataMember = "Country", .ColorDataMember = "NationalColor", .View = New SideBySideBarSeriesView()}
